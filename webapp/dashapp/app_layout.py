    ...
    return html.Div(className="container", children=[
        ...
        html.Div(className="dash-layout", children=[
            ...
            html.Div(className="dash-sidebar", children=[
                ...
                # 2) Estratificação (checkbox + campos dinâmicos)
                html.Div(className="panel mt-14", children=[
                    ...
                    html.Div(id="strat-fields", className="mt-8")  # preenchido via callback
                ]),

                # 3) Eixos + Equação
                html.Div(className="panel mt-14", children=[
                    html.H3("Eixos e Equação", className="panel-title"),
                ...
                html.Div(
                    id="new-model-modal",
                    className="modal",  # começa fechada; callback alterna para "modal show"
                    children=[
                        html.Div(className="modal-content", children=[
                            html.Div(style={"display": "flex", "alignItems": "center", "gap": "12px"}, children=[
                                html.H3("Cadastrar novo modelo", style={"margin": "0"}),
                                html.Button("×", id="nm-cancel", n_clicks=0, className="modal-close"),
                            ]),

                            html.Label("Nome do modelo"),
                            dcc.Input(id="nm-name", type="text",
                                      placeholder="Ex.: WEIBULL_EQ14_CUSTOM", className="input"),
                            ...
                            html.Div(id="nm-vars-spec-wrap", className="mt-8"),
                            ...
                            html.Div(id="nm-init-values-wrap", className="mt-8"),
            ...
            html.Div(className="dash-main", children=[
                html.Div(className="panel sticky", children=[
                    ...
                    html.Div(className="mt-8 row", style={"display": "flex", "gap": "8px", "flexWrap": "wrap"}, children=[
                        html.Button("Remover selecionados", id="remove-btn", n_clicks=0, className="btn"),
                        html.Button("Mostrar IDs removidos", id="show-removed-btn", n_clicks=0, className="btn"),
                        html.Button("Resetar base", id="reset-btn", n_clicks=0, className="btn"),
                        html.Button("Ajustar equação", id="fit-btn", n_clicks=0, className="btn btn-primary"),
                    ]),
                ]),
